...
for (const marker of ['In-Transit', 'Night Travel', 'Track This Phone', 'Campus Radar', '<CampusMap', 'selectedStudent', 'loadCampusRadar']) check(hub.includes(marker), `Safety Mobility UI includes ${marker}.`);
