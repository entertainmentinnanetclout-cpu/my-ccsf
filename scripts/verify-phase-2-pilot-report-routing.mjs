...
requireText(reportForm, 'The case is in the campus queue, but evidence could not be attached after retrying', 'Attachment failure must not hide a created case.');
