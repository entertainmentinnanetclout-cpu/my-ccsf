...
requireText(reportForm, 'const requiresLocation = true;', 'All reports must capture location.');
requireText(reportForm, 'emergency_consent: emergency ? emergencyConsent : false', 'The form must send consent.');
requireText(reportForm, 'No incident explanation is required. Share your location, give consent and submit.', 'Emergency input must remain minimal.');
