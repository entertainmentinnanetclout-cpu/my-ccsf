...
const Index = () => {
  ...
  return <div className="flex min-h-screen items-center justify-center bg-gradient-primary user-theme">
      <motion.div initial={{
      opacity: 0,
      y: 25
    }} animate={{
      ...
      ease: 'easeInOut'
        ...
        <motion.img src={tutLogo} alt="TUT" className="h-20 mx-auto mb-8 logo-glow" initial={{
        scale: 0.9,
        opacity: 0
      }} animate={{
        scale: 1,
        ...
        <motion.h1 className="text-5xl font-bold text-foreground" initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
        ...
        <motion.p className="text-xl text-foreground/90 max-w-md mx-auto" initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
