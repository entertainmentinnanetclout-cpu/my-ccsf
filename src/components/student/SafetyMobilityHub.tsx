          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.55fr)]">
            ...
            <Card className="h-fit border-[#002F6C]/20 shadow-large xl:sticky xl:top-24">
              ...
              <CardContent className="space-y-5 p-5">
                ...
                {radarVisibility === 'campus_exact' && <div className="flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-950/25"><Checkbox id="exact-location-consent" checked={exactConsent} onCheckedChange={(checked) => setExactConsent(checked === true)} /><Label htmlFor="exact-location-consent" className="leading-6">I understand that opted-in campus users may see my exact live position only for the selected limited period. I can disable visibility earlier at any time.</Label></div>}
