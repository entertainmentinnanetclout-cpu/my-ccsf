...
import FormalGovernanceAdmin from './pages/FormalGovernanceAdmin';
import InstitutionalSignoffPack from './pages/InstitutionalSignoffPack';
                  ...
                  <PilotModeProvider>
                    <Routes>
                      ...
                      <Route element={<Layout />}>
                        ...
                        <Route path="/admin/governance/signoff" element={<FeatureRoute feature="admin_portal"><ProtectedRoute allowedRoles={['admin']}><FormalGovernanceAdmin /></ProtectedRoute></FeatureRoute>} />
                        <Route path="/admin/governance/signoff-pack" element={<FeatureRoute feature="admin_portal"><ProtectedRoute allowedRoles={['admin']}><InstitutionalSignoffPack /></ProtectedRoute></FeatureRoute>} />
