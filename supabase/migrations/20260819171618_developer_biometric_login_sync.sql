...
drop trigger if exists sync_developer_biometric_login_credential_trigger on public.developer_biometric_credentials;
create trigger sync_developer_biometric_login_credential_trigger
after insert or update or delete on public.developer_biometric_credentials
for each row execute function public.sync_developer_biometric_login_credential();
